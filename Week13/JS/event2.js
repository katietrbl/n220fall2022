...
let hElement = documentt.getElementByClass("harmony");
...
//half way
let compIndex = selectedColorIndex + 6;

//dont overflow
if(compIndex > 12){
    compIndex = compIndex % 12;
}
//get color
let compColor = colors[compIndex];

hElements[1].style.backgroundColor = color[compIndex];
}
